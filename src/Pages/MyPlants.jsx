        ...
        <table className="min-w-full bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden">
          <thead className="bg-green-100">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-700">Next Watering</th>
              <th className="px-6 py-3 text-left text-sm font-medium text-gray-700">Health</th>
    ...
    myPlants.map(plant => (
      <tr key={plant._id} className="border-t border-gray-200">
        <td className="px-6 py-4">
          <img src={plant.image} alt={plant.name} className="w-16 h-16 object-cover rounded border border-gray-300" />
        </td>
        <td className="px-6 py-4 text-gray-800">{plant.name}</td>
        <td className="px-6 py-4 capitalize text-gray-800">{plant.category}</td>
        <td className="px-6 py-4 text-gray-800">{plant.wateringFrequency}</td>
        <td className="px-6 py-4 text-gray-800">{plant.nextWatering || 'N/A'}</td>
        <td className="px-6 py-4 text-gray-800">{plant.healthStatus || 'Unknown'}</td>
