        ...
        <div className="md:w-1/2 p-5 space-y-4">
          ...
          <div className="pt-4 border-t">
            <p className="text-sm text-gray-500">
              Added by: <span className="font-medium">{plant.userName}</span> (
              <span className="text-green-600">{plant.userEmail}</span>)
            </p>
          </div>
        </div>
      </div>
...
export default DashPlantDetails;
