  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#f9f9f6] text-gray-800 px-5 py-10">
      ...
      <div className="max-w-3xl text-left space-y-4 text-lg">
        ...
        <p>Cookies may be used to enhance your experience on our platform.</p>
        <p>
          You can contact us at support@plantcaretracker.com if you have
          questions about your data or want it deleted.
        </p>
      </div>
    </div>
  );
